...
def plot_candidates(t_data, filename, output_plots):
    ...
    if output_plots:
        fig.savefig("{0}_snr_dm.png".format(os.path.basename(filename)[0:-5]), bbox_inches="tight")
...
def plot_clusters(t_data, filename, output_plots):
    ...
    if output_plots:
        fig.savefig("{0}_clusters.png".format(os.path.basename(filename)[0:-5]), bbox_inches="tight")
...
def plot_candidate_timeline(t_data, filename, output_plots):
    ...
    if output_plots:
        fig.savefig("{0}_timeline.png".format(os.path.basename(filename)[0:-5]), bbox_inches="tight")
